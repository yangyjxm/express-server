...
function orderVenue(data, VenueTypeID) {
  axios({
    url:
      "http://www.chn-hyd.com/XMTYZX/api/services/app/XMVenueBill/WeiXinVenueBillAsync",
    method: "POST",
    data,
    headers: {
...
function payVenue(weixinBillRecordNo, VenueTypeID) {
  axios({
    url:
      "http://www.chn-hyd.com/XMTYZX/api/services/app/XMVenueBill/VenueBillPayByEmpAsync",
    method: "POST",
    data: {
      weixinBillRecordNo,
